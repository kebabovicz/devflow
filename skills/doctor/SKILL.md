...
- Plugin files: `guard.sh`, `ralph-stop-gate.sh`, `init-reminder.sh` exist and are executable in `${CLAUDE_SKILL_DIR}/../../hooks/` (two levels up from this skill's directory = the plugin root).
