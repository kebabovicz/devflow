...
5. **Mark done** in the TODO: check the task off **in place** (one-line result note). Never move it to another section — a single flat list is the loop's memory; duplicated Pending/Completed sections drift apart.
