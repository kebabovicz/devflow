...
| The requirements live in your head, not in a ticket — a feature or a brand-new project | `/devflow:spec` first — agree on the picture, then `task` / `ralph-plan` (or `init` for a new repo) |
