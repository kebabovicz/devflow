...
| `/devflow:research <question>` | Research with the methodology built in: primary sources > team experience > forums > SEO; a mandatory contrarian pass; triangulation; a digest with confidence grades and an honest "what remains unknown" | Before choosing a technology/approach; "what's current practice"; collecting real-world experience including minority views. Works outside devflow projects too |
